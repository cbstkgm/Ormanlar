	...
	((e, t) => {
		...
		function i(m) {
			...
			U(m.step) && (t = m.step, m.step = function(e) {
				...
				return m.preview && m.header && r.preview++, n = e, s = new E(r), p = s.parse(n, t, i), _(), f ? { meta: { paused: !0 } } : p || { meta: { paused: !1 } };
				...
				var t = new RegExp(q(t) + "([^]*?)" + q(t), "gm"), i = (e = e.replace(t, "")).split("\r"), t = e.split("\n"), e = 1 < t.length && t[0].length < i[0].length;
		...
		function E(C) {
			var S = (C = C || {}).delimiter, O = C.newline, x = C.comments, I = C.step, A = C.preview, T = C.fastMode, D = null, L = !1, F = null == C.quoteChar ? "\"" : C.quoteChar, z = F;
			...
			this.parse = function(i, t, r) {
				...
				var n = i.length, e = S.length, s = O.length, a = x.length, o = U(I), h = [], u = [], d = [], l = M = 0;
				if (!i) return v();
